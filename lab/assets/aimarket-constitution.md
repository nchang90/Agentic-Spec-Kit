<!--
Sync Impact Report
- Version change: 1.0.0 -> 1.1.0 (materially expanded infrastructure governance).
- Modified principles: IV. Declarative, Secure Azure Infrastructure (Bicep ->
  Terraform); V. Validated Azure Delivery (IaC validation terminology updated).
- Added sections: none.
- Removed sections: none.
- Templates updated to match:
  - ✅ `.specify/templates/plan-template.md` (constitution gates now Terraform/AVM)
  - ✅ `.specify/templates/spec-template.md` (CR-004 now Terraform/AVM)
  - ✅ `.specify/templates/tasks-template.md` (test rule and setup tasks aligned)
  Reapplied on top of the Spec Kit 1.0.4 templates after migrating this project
  to the Copilot skills layout (`.github/skills/speckit-*/SKILL.md`).
...
Azure infrastructure MUST be declared in Terraform. Implementations MUST use
pinned Azure Verified Modules (AVM) when an applicable module is available; a raw Azure
...
- Task lists MUST include work to test provider portability, server validation and
  ...
  Terraform/AVM/deployment validation.
- A release is blocked until the container build, automated tests, Terraform validation,
...
**Version**: 1.1.0 | **Ratified**: 2026-08-29 | **Last Amended**: 2026-09-06
